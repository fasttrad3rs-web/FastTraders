...
export const mockProducts: MockProduct[] = [
  {
    ...
    brand: 'Schneider Electric', category: 'MCCB', availability: 'ready_stock', unit: 'piece',
    image: placeholder('SCH-CVS100F'), isFeatured: true,
  },
  {
    id: '2', name: 'Terasaki TemBreak 2 S250-NJ 3P 250A MCCB',
    slug: 'terasaki-tembreak-2-s250-nj-3p-250a-mccb', sku: 'TER-S250NJ-3P250',
    brand: 'Terasaki', category: 'MCCB',    availability: 'ready_stock', unit: 'piece',
    image: placeholder('TER-S250NJ'), isFeatured: true,
  },
  {
    id: '3', name: 'Schneider TeSys LC1D18M7 Contactor 18A 3P 220VAC',
    slug: 'schneider-tesys-lc1d18m7-contactor-18a', sku: 'SCH-LC1D18M7',
    brand: 'Schneider Electric', category: 'Contactors', availability: 'ready_stock', unit: 'piece',
    image: placeholder('SCH-LC1D18M7'), 
  },
  {
    id: '4', name: 'Autonics PRCM18-8DN Proximity Sensor M18 PNP NO',
    slug: 'autonics-prcm18-8dn-proximity-sensor', sku: 'AUT-PRCM18-8DN',
    brand: 'Autonics', category: 'Proximity Sensors', availability: 'ready_stock', unit: 'piece',
    image: placeholder('AUT-PRCM18'), 
  },
  {
    id: '5', name: 'Mitsubishi MELSEC iQ-F FX5U-32MT/ES PLC',
    slug: 'mitsubishi-melsec-iq-f-fx5u-32mt-es-plc', sku: 'MIT-FX5U-32MTES',
    brand: 'Mitsubishi Electric', category: 'PLCs & HMIs',    availability: 'ready_stock', unit: 'piece',
    image: placeholder('MIT-FX5U'), isFeatured: true,
  },
  {
    ...
    brand: 'Torex', category: 'Power Cables', availability: 'ready_stock', unit: 'roll',
    image: placeholder('TOR-CAB-3C25'), 
  },
  {
    id: '7', name: 'Pilz PNOZ X2.8P Safety Relay 24V AC/DC',
    slug: 'pilz-pnoz-x2-8p-safety-relay', sku: 'PIL-PNOZX28P',
    brand: 'Pilz', category: 'Safety Relays',    availability: 'import_on_request', unit: 'piece',
    image: placeholder('PIL-PNOZX28P'), 
  },
  {
    ...
    brand: 'WAGO', category: 'Terminal Blocks', availability: 'available_on_order', unit: 'box',
    image: placeholder('WAG-221413'), 
  },
];
